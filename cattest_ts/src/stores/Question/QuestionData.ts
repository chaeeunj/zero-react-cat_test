...
export const QuestionData: IQuestion[] = [
  ...
  {
    id: 3,
    title: '아무리봐도 우리 고양이가 정말 예쁜 것 같다. 나의 행동은?',
    answera:
      '"너무 예뻐.. 사람들한테 자랑해야지..!" 하며 인스타를 만들어 사진을 공유하고 소통도 한다.',
    answerb: '우리 고양이 너무 예쁘다. 사진 찍어서 사진첩에 간직한다.',
    type: 'EI',
  },
  {
    id: 4,
    title: '고양이 유튜브를 시작하려고 한다. 나는 어떤 유튜버를 만들고 싶은가?',
  ...
  },
  {
    id: 5,
    title:
      '고양이에 대해 모르는 부분들을 검색하고 있다. 내가 글을 읽는 방법은?',
  ...
  },
  {
    id: 7,
    title:
      '같은 집사 친구가 고양이가 아픈 것 같아 슬퍼하고 있다. 나의 반응은?',
    answera: '이건 이렇게 하면 어떨까? 해결책을 함께 생각하여 정보들을 같이 찾아본다.',
  ...
  },
  {
    id: 9,
    title:
      '고양이가 아파서 병원을 고르려고 리뷰를 보았다. 내가 갈 병원은?',
  ...
  },
  {
    ...
    title:
      '고양이 사료를 급여하는 방법은?',
    answera: '우리 고양이 몸무게는 5키로니까 하루 세번 몇시에 이만큼 씩 주고, 간식은 이때 챙겨줘야겠다.',
